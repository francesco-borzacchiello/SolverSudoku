""" 
solver: https://sudoku9x9.com/howtosolve.php
...
""" 
it stalls
sudoku = ClassicSudoku([[5, 0, 0, 0, 0, 0, 0, 3, 0],
                        [4, 0, 8, 9, 3, 0, 6, 0, 0],
                        [0, 0, 0, 4, 0, 8, 0, 5, 0],
                        [0, 8, 0, 0, 0, 7, 0, 0, 6],
                        [9, 0, 0, 0, 0, 0, 0, 0, 2],
...
""" sudoku = ClassicSudoku([[0, 7, 0, 8, 0, 0, 0, 0, 0],
                        [0, 0, 0, 7, 0, 0, 9, 0, 0],
                        [0, 9, 0, 0, 0, 3, 1, 0, 6],
                        [0, 5, 6, 1, 0, 0, 0, 0, 8],
                        [0, 0, 0, 0, 7, 0, 0, 0, 0],
...
""" sudoku = ClassicSudoku([[0, 0, 0, 0, 1, 0, 6, 0, 0],
                        [9, 0, 0, 0, 0, 7, 0, 3, 0],
                        [0, 8, 0, 2, 0, 0, 0, 1, 0],
                        [0, 0, 1, 0, 4, 0, 0, 9, 0],
                        [0, 0, 0, 0, 0, 0, 0, 8, 0],
...
sudoku = ClassicSudoku([[0, 0, 9, 0, 5, 0, 6, 0, 0],
                        [0, 0, 2, 0, 6, 0, 0, 0, 4],
                        [0, 3, 0, 7, 0, 4, 0, 0, 1],
                        [0, 0, 0, 0, 0, 0, 5, 0, 9],
                        [0, 0, 0, 6, 0, 3, 0, 0, 0],
